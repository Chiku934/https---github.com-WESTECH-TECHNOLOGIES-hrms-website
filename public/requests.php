...
<div class="shell-card">
    <h2 style="margin:0 0 8px;color:#111827;">Requests</h2>
    <p style="margin:0;color:#475569;">This page is now aligned to the shared myteam shell and is ready to be expanded with request workflows and approvals.</p>
</div>';
